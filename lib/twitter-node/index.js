...
//
// Returns nothing.
TwitterNode.prototype.untrack = function untrack(word) {
  for (var i in this.trackKeywords) {
    if (this.trackKeywords[i] == word) {
      this.trackKeywords.splice(i,1);
    }
  }
  return this;
};
